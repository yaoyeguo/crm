 ...
 * @version 0.1b
 */
class ecorder_rpc_response_order_add_drp extends ecorder_rpc_response_order_add_abstract implements ecorder_rpc_response_order_add_interface {
    ...
    protected function parseSdf($sdf)
    {
        ...
        $this->_orderSdf = $sdf;
        $selling_agent = json_decode($sdf['member_info'],true);
