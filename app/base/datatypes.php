...
$datatypes = array(
    'money'=>array(
        'sql'=>'decimal(20,2)',
        'searchparams'=>array('nequal'=>app::get('base')->_('等于'),'sthan'=>app::get('base')->_('小于等于'),'bthan'=>app::get('base')->_('大于等于'),'between'=>app::get('base')->_('介于')),
    ...
    'time'=>array(
        ...
        'searchparams'=>array('than'=>app::get('base')->_('晚于'),'lthan'=>app::get('base')->_('早于'),'between'=>app::get('base')->_('介于')),
    ),
    'cdate'=>array(
        'sql'=>'integer(10) unsigned',
    ),
