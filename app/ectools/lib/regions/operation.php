...
class ectools_regions_operation
{
    ...
    public function getRegionById($regionId='')
    {
		...
		if ($regionId)
			$aTemp = $this->model->getList('region_id,p_region_id,local_name,ordernum,region_path,group_name', array('p_region_id' => $regionId), 0, -1, 'ordernum ASC,region_id ASC');
		else
			$aTemp = $this->model->getList('region_id,p_region_id,local_name,ordernum,region_path,group_name', array('region_grade' => '1'), 0, -1, 'ordernum ASC,region_id ASC');
