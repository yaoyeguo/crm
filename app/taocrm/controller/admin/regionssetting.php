...
class taocrm_ctl_admin_regionssetting extends desktop_controller{

    var $workground = 'taocrm_ctl_regionssetting';
    ...
    function index(){
        ...
        $model = &app::get('ectools')->model('regions');
        ...
        $this->page('admin/regionssetting/index.html');
    }
