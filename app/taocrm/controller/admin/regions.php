...
class taocrm_ctl_admin_regions extends desktop_controller{
    ...
    private function showarea()
	{
        ...
        if ($obj_regions_op->getTreeSize())
		{
            ...
            $this->page('admin/regions/area_treeList.html');
        }
		else
		{
            $obj_regions_op->getMap();
            $this->pagedata['area'] = $obj_regions_op->regions;
            $this->page('admin/regions/area_map.html');
        }
    }
    ...
    public function detailDlArea($aRegionId)
	{
        ...
        $oObj = app::get('ectools')->model('regions');
    ...
    public function updateOrderNum()
	{
        ...
        $is_update = true;
        $dArea = app::get('ectools')->model('regions');
