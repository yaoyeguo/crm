...
class taocrm_taobaoapi
{
    public $appkey;
    public $secretKey;
    //public $gatewayUrl = "http://gw.api.taobao.com/router/rest";
    public $gatewayUrl = "http://gw.api.matrix.shopex.cn/router/rest";
    public $format = "xml";
...
//                     判断是不是文件上传
    ...
    protected function logCommunicationError ($apiName, $requestUrl, $errorCode, $responseTxt)
    {
        ...
        $logData = $apiName . "\t" . 'errorCode:' . $errorCode . "\t" .
    ...
    public function execute ($method, $params, $session = null)
    {
        ...
        try {
            ...
            "HTTP_ERROR_" . $e->getCode(), $e->getMessage());
            return false;
        }
        ...
        if (isset($respObject->code)) {
            $this->logBizError($sysParams["method"], $respObject->code,
            $respObject->msg, $respObject->sub_code, $respObject->sub_msg);
        }
        return $respObject;
    }
}
