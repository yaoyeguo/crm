...
class content_ctl_site_article extends content_controller 
{
    ...
    public function lists() {
		...
		if($article_ids)
		{
			$sql = "SELECT a.* , b.storage, b.s_url FROM `sdb_content_article_bodys` a LEFT JOIN `sdb_image_image` b ON a.image_id = b.image_id WHERE a.article_id IN (" .join(',' , $article_ids).")";
