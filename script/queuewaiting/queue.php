...
require_once(S_BASE_DIR . 'queuewaiting/queueManager.php');
...
//写入数据库
$task_name = 'php_queuewaiting/'.basename(__FILE__,".php");
...
if($cnt['cnt']){
    ...
    $sql = "INSERT INTO `sdb_desktop_surveillance` (
                ...
                VALUES (
                NULL , '".$task_name."','每分钟', '".$begin_time."', '".time()."','".$time_consuming."','日常实时队列任务'
                );";
}
